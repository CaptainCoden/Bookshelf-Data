// Images for random book backgrounds
const imageURLs = [
    "https://storage.googleapis.com/webdesignledger.pub.network/LaT/edd/2016/02/20th-century-deconstructed-vintage-book-texture-10-780x1289.jpg",
    "https://storage.googleapis.com/webdesignledger.pub.network/LaT/edd/2016/02/grungy-front-book-cover-1.jpg",
    "https://as1.ftcdn.net/v2/jpg/00/05/68/46/1000_F_5684670_WM3V1Fk486SU08YBHBmuNmNi83m7m0f8.jpg",
    "https://as2.ftcdn.net/v2/jpg/00/60/76/61/1000_F_60766104_HQICYiCkIB3QP43hqvOwhcxciSUPXJNf.jpg",
    "https://as2.ftcdn.net/v2/jpg/00/11/51/23/1000_F_11512380_i7dkwTyxAtggJG5Gz5UKvgIIBI5NhA9G.jpg",
    "https://as1.ftcdn.net/v2/jpg/00/60/36/92/1000_F_60369235_0WbAKFjMMuF8EoP5ixfLBMlWcQpTjTJZ.jpg",
    "https://as2.ftcdn.net/v2/jpg/00/05/32/83/1000_F_5328391_nfLRyUUdYTV6UkryIeVnTmXfWrCPmeRQ.jpg",
    "https://i.pinimg.com/736x/25/f5/48/25f548f6174edee68702535de1ebea06.jpg"
];
...
class Book {
    ...
    render() {
        ...
        bookElement.style.backgroundImage = `url(${imageURLs[randomIndex]})`;
        // Need to create the "flipping" effect (mostly to fit all the info in)
        bookElement.innerHTML = `
        <div class="front-content book-content">
        <h1>${this.title}</h1>
        <h4>By ${this.author}</h4>
        </div>
        <div class="back-content book-content hidden">
        <h6>${this.subject}</h6>
        <p>${this.language}</p>
        </div>
        `;
        bookElement.querySelector(".back-content").classList.add("hidden");
        bookElement.addEventListener("mousedown", () => {
            bookElement.querySelector(".front-content").classList.add("hidden");
            bookElement.querySelector(".back-content").classList.remove("hidden");

        });

        bookElement.addEventListener("mouseup", () => {
            bookElement.querySelector(".front-content").classList.remove("hidden");
            bookElement.querySelector(".back-content").classList.add("hidden");
        });
...
// Get rid of the landing message and start the song
...
class Bookshelf {
    ...
    render() {
        ...
        for (let i = 0; i < this.books.length; i++) {
          const bookElement = this.books[i].render();
...
const bookData = [
    {
        ...
        title: "Adding a book to the array",
      },
    {
